...
@interface HXFakeLocationDetectUtil ()
...
@implementation HXFakeLocationDetectUtil
...
+ (instancetype)util {
    ...
    static HXFakeLocationDetectUtil *instance = nil;
...
- (instancetype)init {
    self = [super init];
    if (self) {
        self.isSuspeciousJail = [HXFakeLocationDetectUtil isJailedDevice];
